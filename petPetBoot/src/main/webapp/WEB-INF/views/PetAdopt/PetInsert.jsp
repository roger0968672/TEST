   ...
   <!-- 首頁 start -->
            ...
            <div class="dataBlock" id="petInsertCell">
                ...
                <form  method="post" action="petInsert.controller" enctype="multipart/form-data"> 
                    ...
                    <div class="input-group input-group-lg div">
						...
						style="width: 30px;" id="petID" onblur="checkpetname();">
                    </div>
                    <a id="petnamea" class="peterrora"></a>
                      ...
                      <div class="input-group flex-nowrap input-group-lg div  ">
						<span class="input-group-text petdivdiv">寵物性別</span>
						<a style="font-size: 24px; margin-left: 5px;">公<input type="radio" name="petGender" value="公" class="petgenderradio" checked="checked"  ></a>
						<a style="font-size: 24px;">母<input type="radio" name="petGender" value="母" class="petgenderradio"></a>
                        
                        <label  class="input-group-text petdivdiv petbreedsla" for="inputGroupSelect01" style="margin-left: 5px;">寵物種類</label>
                        <select  class="form-select " id="inputGroupSelect01" style="width: 50px;" name="petSpecies">
					...
					<div class="input-group input-group-lg div">
                        ...
                        <input type="text" class="form-control"  name="petColor" id="petcolor" style="width: 30px;" onblur="checkpetcolor();">
                    </div>
					<a id="petcolora" class="peterrora"></a>

					<div class="input-group input-group-lg div">
                        <span class="input-group-text petdivdiv" >寵物品種</span>
                        <input type="text" class="form-control"  name="petBreeds" style="width: 30px;" id="petbreeds" onblur="checkpetbreeds();">
                    </div>
                    ...
                    <div class="input-group ">
                        ...
                        <textarea class="form-control" aria-label="With textarea" cols="30" rows="3" id="picAdoptText1" 
                        name="petNarrate" onblur="checkpetarea()"></textarea>
                    ...
                    <div class="input-group flex-nowrap input-group-lg div">
                        ...
                        <input type="file" class="form-control" name="petPic1" id="petpic1" accept="image/*" onchange="checkpetimg1()">
                    </div> 
                    <a id="petimg1a" class="peterrora"></a>
					  <img class="imgpic1" src="#" id="img1"/> 
					<div class="input-group flex-nowrap input-group-lg div">
                        <span class="input-group-text petdivdiv">寵物圖片2</span>
                        <input type="file" class="form-control" name="petPic2" id="petpic2" accept="image/*"  onchange="checkpetimg2()">
                    </div>  
                    <a id="petimg2a" class="peterrora"></a>
					  <img class="imgpic1" src="#" id="img2"/> 
					<div class="input-group flex-nowrap input-group-lg div ">
                        <span class="input-group-text petdivdiv" >寵物圖片3</span>
                        <input type="file" class="form-control" name="petPic3" id="petpic3" accept="image/*"  onchange="checkpetimg3()">
                    </div>  
                    <a id="petimg3a" class="peterrora"></a>
					  <img class="imgpic1" src="#" id="img3"/> 

                    

			        <div class="btnBlock gap-3 col-6 mx-auto container">
						<input type="button" value="送出" class="button btn btn-success" id="petsubmit" style="width:80px;height:40px; ">
						<input type="reset" value="重新編寫" class="button btn btn-success" style="width:100px;height:40px; "> 
                    </div>
                </form>
                <div class="last"></div>
            </div>
	...
	<script type="text/javascript">
        ...
        //-----------------------------------------------------
		   ...
		   var petimg1flag=true;
		   var petimg2flag=true;
		   var petimg3flag=true;
$("#petsubmit").click(function(){
	...
	checkpetimg2();
	checkpetimg3();
  if(petnameflag && petcolorflag && petbreedsflag && petareaflag && petimg1flag && petimg2flag && petimg3flag){
      $("#petsubmit").attr("type","submit");
      $("#petsubmit").click();
   }else{
  	 swal("資料尚未輸入完成", "", "error");
       }
...
//---------------------------------------圖片檢查-----------------------
function checkpetimg1(){
	 petimg1=$("#petpic1").val();
  if(petimg1.length==""){
      $("#petimg1a").html("圖片一未選擇");
      $("#petimg1a").css("display","inline");
	   petimg1flag=false;
   }
  else{
	  $("#petimg1a").html(" ");
	  $("#petimg1a").css("display","none");
	   petimg1flag=true;}
}

function checkpetimg2(){
	 petimg2=$("#petpic2").val();
	  if(petimg2.length==""){
	      $("#petimg2a").html("圖片二未選擇");
	      $("#petimg2a").css("display","inline");
		   petimg1flag=false;
	   }
	  else{
		  $("#petimg2a").html(" ");
		  $("#petimg2a").css("display","none");
		   petimg1flag=true;}
	}
	
function checkpetimg3(){
	 petimg3=$("#petpic3").val();
	  if(petimg3.length==""){
	      $("#petimg3a").html("圖片三未選擇");
	      $("#petimg3a").css("display","inline");
		   petimg1flag=false;
	   }
	  else{
		  $("#petimg3a").html(" ");
		  $("#petimg3a").css("display","none");
		   petimg1flag=true;}
	}
	</script>
</body>
